...
var ghostTrack = new Audio("/Game/audio/Death Issues.mp3");
soundsArr.push(ghostTrack);

var hit        = new Audio("/Game/audio/Hit.mp3");
hit.volume = 0.5;
soundsArr.push(hit);

var blip       = new Audio("/Game/audio/BlipSoft.mp3");
blip.volume = 0.2;
soundsArr.push(blip);

var warn       = new Audio("/Game/audio/Warn.mp3");
soundsArr.push(warn);

var scythe1    = new Audio("/Game/audio/Scythe.wav");
var scythe2    = new Audio("/Game/audio/Scythe 2.wav");
scythe1.volume = 0.6;
scythe2.volume = 0.6;
soundsArr.push(scythe1);
soundsArr.push(scythe2);

var pickitem   = new Audio("/Game/audio/Pick Item.mp3");
pickitem.volume = 0.5;
soundsArr.push(pickitem);

var explosion  = new Audio("/Game/audio/Explosion.mp3");
explosion.volume = 0.8;
var bombfuse   = new Audio("/Game/audio/Bomb Fuse.mp3");
soundsArr.push(explosion);
soundsArr.push(bombfuse);

var deathMarch = new Audio("/Game/audio/Death March.mp3");
var surviMarch = new Audio("/Game/audio/Survival March.mp3");
soundsArr.push(deathMarch);
soundsArr.push(surviMarch);

var crickets1   = new Audio("/Game/audio/Crickets 1.mp3");
var crickets2   = new Audio("/Game/audio/Crickets 2.mp3");
var crickets3   = new Audio("/Game/audio/Crickets 3.mp3");
...
var snd_ratHit  = new Audio("/Game/audio/ratHit.mp3");
var snd_powerUp = new Audio("/Game/audio/powerup.mp3");
soundsArr.push(snd_ratHit);
soundsArr.push(snd_powerUp);

var snd_deathTemptation = new Audio("/Game/audio/Death Temptation.mp3");
soundsArr.push(snd_deathTemptation);

var snd_perfect = new Audio("/Game/audio/Perfect Sound.mp3");
